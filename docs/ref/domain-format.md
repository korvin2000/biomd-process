...
**`INV-1 … INV-28` are all implemented.** `INV-15` and `INV-16` landed last (2026-08-25); note
that `INV-16` has no finding code of its own, because it *is* the pair of exemptions applied
inside the `INV-15` check.
